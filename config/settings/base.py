...
WHOLESALE_INVOICE_SELLER_NAME = os.environ.get(
    "WHOLESALE_INVOICE_SELLER_NAME",
    "Chokher Alo",
)
WHOLESALE_INVOICE_SELLER_GSTIN = os.environ.get(
    "WHOLESALE_INVOICE_SELLER_GSTIN",
    "",
)
WHOLESALE_INVOICE_SELLER_ADDRESS = os.environ.get(
    "WHOLESALE_INVOICE_SELLER_ADDRESS",
    "",
)
WHOLESALE_INVOICE_SELLER_STATE = os.environ.get(
    "WHOLESALE_INVOICE_SELLER_STATE",
    "",
)
WHOLESALE_INVOICE_SELLER_EMAIL = os.environ.get(
